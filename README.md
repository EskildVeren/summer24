...
## 05.09; Norway's data analyst number 1

I took a tiny pause from chess to do some data analasys. While living in Oslo this summer, I have bought a lot of groceries for my parents, and made a lot of dinner. I am supposed to ask for money for this, but I often forget this. Money is currently tights, so I started thinking about the best way to find out how much money is owed. I was considering going through transactions manually, but this would take a lot of time, and I would need to match with reciepts in order to see what I should pay, and what my parents should pay. Then I remembered that the different supermarket companies stores a lot of my personal data, and that we have the rights to see my data. I looked further into it, and it is fully possible to download my own data from allt hese comapnies using trumf, Æ or the coop app. I then used python notebooks to see how much money is owed. This was quite easy, because my parents pay for certain products (such as broccolo), whil I pay for others (mostly the unhealthy foods, such as energy drinks and icecream). This may be one of the few times aprogrammer has set out to make a program to make their life easier, and they actually spent less time developing the script, rather that doing the manual work. Fun stuff
